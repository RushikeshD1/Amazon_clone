...
const elecHeader = 
    ["Tv & Home Entertainment","Electronic","Mobiles & Accessories","Gaming & Accessories","Audio"]
        ...
        <div className=" flex flex-row items-center justify-start h-14 gap-4 pl-8 bg-white ">
            ...
            {items === "Mobiles & Accessories" &&                   
                <span className="fixed left-0 hidden group-hover:block bg-transparent w-screen">
                    <div className="h-4 w-4 translate-x-[340px] translate-y-1/2 rotate-45 bg-white border-l border-t border-gray-200"></div>
                ...
                {items === "Audio" &&                   
                <span className="fixed left-0 hidden group-hover:block bg-transparent w-screen">
                    <div className="h-4 w-4 translate-x-[565px] translate-y-1/2 rotate-45 bg-white border-l border-t border-gray-200"></div>
                    <FlyoutLink FlyoutContent={AudioAccess} elecHeader={elecHeader[0]} />
                </span>}
                {items === "Gaming & Accessories" &&                   
                <span className="fixed left-0 hidden group-hover:block bg-transparent w-screen">
                    <div className="h-4 w-4 translate-x-[470px] translate-y-1/2 rotate-45 bg-white border-l border-t border-gray-200"></div>
                    <FlyoutLink FlyoutContent={GamingAccess} elecHeader={elecHeader[0]} />
                </span>}
                {items === "Electronic" &&                   
                <span className="fixed left-0 hidden group-hover:block bg-transparent w-screen">
                    <div className="h-4 w-4 translate-x-[240px] translate-y-1/2 rotate-45 bg-white border-l border-t border-gray-200"></div>
                    <FlyoutLink FlyoutContent={ElectronicAccess} elecHeader={elecHeader[0]} />
                </span>}
            </div>)}
        </div>
        <div className="flex flex-row ">
            <div className=" border border-l-2 w-72 sm:block hidden bg-white">
